        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            <div class="container-fluid">
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <!-- <li class="nav-item">
                    <a class="nav-link" href="http://localhost/praktikum2/tambah_kelas.php">Tambah Kelas</a>
                    </li>
                    <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="http://localhost/praktikum2/tambah_siswa.php">Tambah Siswa</a>
                    <li class="nav-item">
